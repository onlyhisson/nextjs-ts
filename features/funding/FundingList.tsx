...
const F_LIST = [
  {
    ...
    thumbnail:
      "https://images.unsplash.com/photo-1642505172378-a6f5e5b15580?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OHx8Y2xlYW5lcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60",
    type: "funding",
  },
  {
    id: 2,
  ...
  return (
    <Wrapper>
      <div className="fl-top">
        <div>
          <Span>{moment("2022-06-16 18:10:20").format("DD MMM ddd")}</Span>
        </div>
        <CloseBtn onClick={onClick} />
      </div>
      <div className="fl-body">{renderdFundings}</div>
    </Wrapper>
  );
};
